...
#SBATCH --output=/hpcwork/lect0151/stablelofieditor/AudioLDM-training-finetuning/logs/infer_xcm_v1%j.log
#SBATCH --mem=120G
...
python3 audioldm_train/infer.py --config_yaml audioldm_train/config/2023_08_23_reproduce_audioldm/audioldm_original_xcm_v1.yaml --reload_from_ckpt /hpcwork/lect0151/stablelofieditor/AudioLDM-training-finetuning/log/latent_diffusion/2023_08_23_reproduce_audioldm/audioldm_original_xcm_v1/checkpoints/checkpoint-fad-133.00-global_step=69999.ckpt --list_inference tests/captionlist/inference_xcm_v1.lst
